...
{
    public class AddAppointmentViewModel : NotifyPropertyChangedBase
    {
        ...
        public AddAppointmentViewModel(ICollection<CustomAppointment> appointments) : this()
        {
        ...
        public AddAppointmentViewModel(ICollection<CustomAppointment> appointments, DateTime startDate, DateTime endDate) : this(appointments)
        {
            this.StartTime = startDate.TimeOfDay;
            this.EndTime = endDate.TimeOfDay;
