...
namespace SDKBrowser.Examples.CalendarControl.SchedulingCategory.TimelineStylingExample
{
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class TimelineStyling : ContentView
    {
        public TimelineStyling ()
        {
            InitializeComponent();
